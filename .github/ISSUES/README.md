...
|----|-------|----------|--------|
| [001](001-poison-emails-infinite-retry.md) | Poison emails cause infinite retry loops | `daemon.py:708-763` | Fixed (PR #13) |
| [002](002-llm-call-no-timeout.md) | LLM call has no timeout | `daemon.py:518` | Fixed (PR #13) |
| [003](003-fragile-json-parsing.md) | Fragile JSON parsing of LLM output | `daemon.py:527-544` | Fixed (PR #13) |
| [004](004-smtp-no-timeout-retry.md) | SMTP send has no timeout or retry | `daemon.py:696-699` | Fixed (PR #13) |
| [010](010-no-auto-reply-loop-protection.md) | No protection against auto-reply email loops | `daemon.py:550-596`, `email_client.py:715-776` | Fixed (PR #11) |

### High (Correctness/Reliability)

| ID | Title | Location | Status |
|----|-------|----------|--------|
| [005](005-ics-content-not-validated.md) | ICS content never validated | `daemon.py:683-692` | Fixed (PR #13) |
